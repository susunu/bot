...
wait = {
    ...
    'timeline':False,
    'autoAdd':False,
    'message':"Thanks add me  ─•✵✟۞ ℓℓஆՁゆຸ۞✵•─     🇹🇭🇹🇭🇹🇭🇹🇭🇹🇭🇹🇭🇹🇭🇹🇭🇹🇭  http://line.me/ti/p/ShgslAPyYS   ",
    "lang":"JP",
    "comment":"Auto like   ─•✵✟۞ ℓℓஆՁゆຸ۞✵•─  🇹🇭🇹🇭🇹🇭🇹🇭🇹🇭🇹🇭🇹🇭🇹🇭🇹🇭🇹🇭   http://line.me/ti/p/ShgslAPyYS   ",
    "likeOn":False,
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
...
def bot(op):
    try:
        ...
        if op.type == 13:
		    ...
		    time.sleep(0.00)
		    ko.cancelGroupInvitation(op.param1, matched_list)
		    time.sleep(0.00)
		    kj.cancelGroupInvitation(op.param1, matched_list)
                    time.sleep(0.00)
        if op.type == 17:
            if mid in op.param3:
		...
		ko.sendText(msg.to,"🛡️ ป้องกันลิ้งค์ ✔️OK")
		kj.sendText(msg.to,"🛡️ ป้องกันลิ้งค์ ✔️OK")
		    ...
		    ko.sendText(msg.to,"🔓เลิกป้องกันลิ้งค์ 🀄ยก เลิกแล้ว✔️")
		    kj.sendText(msg.to,"🔓เลิกป้องกันลิ้งค์ 🀄ยก เลิกแล้ว✔️")
                else:
...
#--------------------------------------------------------
		    ...
		    time.sleep(0.00)
				...
				time.sleep(0.00)
                                ko.sendText(msg.to,"6")
				time.sleep(0.00)
				kj.sendText(msg.to,"7")	
				time.sleep(0.00)
#-----------------------------------------------------------         
	    ...
	    elif "K5 kick" in msg.text:
				OWN = "u2dca8b90516945d563e1cf62d3515be2","u2c7f708769a2eb35d9ae9f73cd366e0b"
				if msg.from_ in OWN:
					pass
				else:
					nk0 = msg.text.replace("K5 kick","")
					nk1 = nk0.lstrip()
					nk2 = nk1.replace("@","")
					nk3 = nk2.rstrip()
					_name = nk3
	    ...
	    elif "K6 kick" in msg.text:
				OWN = "u2dca8b90516945d563e1cf62d3515be2","u2c7f708769a2eb35d9ae9f73cd366e0b"
				if msg.from_ in OWN:
					pass
				else:
					nk0 = msg.text.replace("K6 kick","")
					nk1 = nk0.lstrip()
					nk2 = nk1.replace("@","")
					nk3 = nk2.rstrip()
					_name = nk3
	    ...
	    elif "K7 kick" in msg.text:
				OWN = "u2dca8b90516945d563e1cf62d3515be2","u2c7f708769a2eb35d9ae9f73cd366e0b"
				if msg.from_ in OWN:
					pass
				else:
					nk0 = msg.text.replace("K7 kick","")
					nk1 = nk0.lstrip()
					nk2 = nk1.replace("@","")
					nk3 = nk2.rstrip()
					_name = nk3
...
#-----------------------------------------------------------
				...
				if msg.to in protection:
					...
					ko.sendText(msg.to,"🔐 ⚡ป้องกัน กลุ่ม OK.รับทราบ.ป้องกันแล้ว⚡ 🔐✔️")
					kj.sendText(msg.to,"🔐 ⚡ป้องกัน กลุ่ม OK.รับทราบ.ป้องกันแล้ว⚡ 🔐✔️")
				...
				try:
					if msg.from_ in Administrator:
						...
						ko.sendText(msg.to,"🀄 ยกเลิก.การป้องกัน OK.รับทราบ ยกเลิกการป้องกัน แล้ว❗👌")
						kj.sendText(msg.to,"🀄 ยกเลิก.การป้องกัน OK.รับทราบ ยกเลิกการป้องกัน แล้ว❗👌")
					else:
						cl.sendText(msg.to,"ƛԼƦЄƛƊƳ ƠƑƑ") 										
				except:
					pass
		   ...
		   ko.sendText(msg.to,"🌟🔐 ป้องกันชื่อกลุ่ม OK รับทราบ ป้อง กันชื่อกลุ่มแล้ว 👌 🔐🌟")
		   kj.sendText(msg.to,"🌟🔐 ป้องกันชื่อกลุ่ม OK รับทราบ ป้อง กันชื่อกลุ่มแล้ว 👌 🔐🌟")
		    ...
		    ko.sendText(msg.to," 🀄🔓OK รับทราบ ยกเลิก ป้องกันชื่อห้อง แล้ว 👌 🔓")
		    kj.sendText(msg.to," 🀄🔓OK รับทราบ ยกเลิก ป้องกันชื่อห้อง แล้ว 👌 🔓")
				...
				ko.sendText(msg.to,"🀄 รับทราบ.ป้องกันการเชิญ OK 👌 ป้องกัน แล้ว")
				kj.sendText(msg.to,"🀄 รับทราบ.ป้องกันการเชิญ OK 👌 ป้องกัน แล้ว")
				...
				try:
					...
					ko.sendText(msg.to,"🀄 ยกเลิกป้องกัน การเชิญ รับทราบ  👌 OK ยกเลิก แล้ว")
					kj.sendText(msg.to,"🀄 ยกเลิกป้องกัน การเชิญ รับทราบ  👌 OK ยกเลิก แล้ว")
				except:
					pass                                 
#---------------FUNGSI RATAIN GRUP TANPA KICK SESAMA BOT/Admin/Bots----------#
...
#-----------------------------------------------------------
		       ...
		       ko.sendText(g.mid,"Spam  😂")
		       kj.sendText(g.mid,"Spam  😂")		       
...
#-----------------------------------------------------------
		...
		ko.sendText(msg.to,"ƤƠƝƓ 􀨁􀄻double thumbs up􏿿􀜁􀅔Har Har􏿿")
		kj.sendText(msg.to,"ƤƠƝƓ 􀨁􀄻double thumbs up􏿿􀜁􀅔Har Har􏿿")
#----------------------------------------------------------
		...
		ko.sendText(msg.to,"ƁƠƬ ԼƖƝЄ 6")
		kj.sendText(msg.to,"ƁƠƬ ԼƖƝЄ 7")
...
#========================================        
        ...
        if op.param1 in autocancel:
			...
			if op.param2 in OWN:
				...
				ko.cancelGroupInvitation(op.param1,InviterX)
